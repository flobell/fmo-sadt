 ...
 * @author Felixpga
 */
class Application_Model_DbTable_Adjunto extends Application_Model_DbTable_Abstract
{
    protected $_name = 'adjunto';
    ...
    //protected $_dependentTables = array('Application_Model_DbTable_Direccion');
